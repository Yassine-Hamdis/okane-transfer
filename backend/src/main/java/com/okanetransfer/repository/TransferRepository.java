...
public interface TransferRepository extends JpaRepository<Transfer, Long> {
    ...
    // ← this was missing — WithdrawalCodeGenerator needs it
    ...
    List<Transfer> findAllByReceivingAgentId(Long agentId);

    List<Transfer> findAllByCorridorId(Long corridorId);

    List<Transfer> findAllByRecipientPhone(String phone);
